...
body, table {
	font: 12pt "Times new roman", Times, Georgia, serif !important;
	font: 12pt "Times new roman", Times, Georgia, serif;
}

pre, textarera, tt, code {
	font: 12pt/1.6 Monaco, Lucidatypewriter, "Lucida console", monospace !important;
	font: 12pt/1.6 Monaco, Lucidatypewriter, "Lucida console", monospace;
}

select, input {
	font: 12pt/1.6 "Times new roman", Times, Georgia, serif !important;
	font: 12pt/1.6 "Times new roman", Times, Georgia, serif;
}
